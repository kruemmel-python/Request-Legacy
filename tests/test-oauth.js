...
tape('reqsignRSA', function (t) {
  ...
  t.ok(reqsignRSA && reqsignRSA.length > 0, 'RSA signature generated')
  t.end()
})
...
tape('accsignRSA', function (t) {
  ...
  t.ok(accsignRSA && accsignRSA.length > 0, 'RSA signature generated')
  t.end()
})
...
tape('upsignRSA', function (t) {
  ...
  t.ok(upsignRSA && upsignRSA.length > 0, 'RSA signature generated')
  t.end()
})
...
tape('rfc5849 RSA example', function (t) {
  ...
  process.nextTick(function () {
    // different signature in rfc5849 because request sets oauth_version by default
    t.ok(getSignature(rfc5849RSA).length > 0, 'RSA signature generated')
    rfc5849RSA.abort()
    t.end()
  })
})
...
tape('no credentials on external redirect', function (t) {
  const s2 = http.createServer(function (req, res) {
    res.writeHead(200, { 'content-type': 'text/plain' })
    res.end()
  })
  const s1 = http.createServer(function (req, res) {
